...
import com.gamegearhub.jwtservice.JwtAuthFilter;
...
public class SecurityConfig {
	...
	@Bean
	 SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		}).authorizeHttpRequests(auth -> auth.requestMatchers("auth/**", "/game/**", "/user/adduser", "/admin/addadmin")
				.permitAll().requestMatchers(AUTH_ALLOWED).permitAll().requestMatchers(HttpMethod.POST, "/users")
				.permitAll().requestMatchers("/admin/**", "/user/**").authenticated())
